...
export const experiences: ExperienceItem[] = [
  {
    ...
    highlights: [
      ...
      'Engineered 30+ REST APIs across web, Android, and third-party systems for rent collection, automated lease agreements, document workflows, tenant verification, and property operations using NestJS, TypeScript, and PostgreSQL.',
  ...
  },
  {
    ...
    summary:
      'Researched deep convolutional neural networks for histopathological cancer image classification and built clinician workflow applications.',
    highlights: [
      'Researched breast cancer subtype classification from histopathological images with ResNet and MobileNet deep convolutional networks; connected predictions to LLM-generated diagnostic explanations for clinician-friendly reporting.',
      'Built internal FastAPI and React applications for clinical data collection, workflow visualization, and research management.'
    ],
    technologies: [
      'PyTorch',
      'Computer Vision',
