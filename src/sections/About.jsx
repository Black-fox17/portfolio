...
function About() {
    ...
    return (
        <>
            <Helmet>
                <title>Ayeleru Abdulsalam - AI/ML Engineer & Full-Stack Developer</title>
                <meta
                name="description"
                content="Hi, I'm Ayeleru Abdulsalam Oluwaseun, an AI/ML engineer and full-stack developer with expertise in Laravel, Django, React, FastAPI, and more."
                />
                <link rel="canonical" href="https://salam-portfolio-three.vercel.app/" />
            </Helmet>
